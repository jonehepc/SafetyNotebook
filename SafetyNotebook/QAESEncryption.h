...
#ifndef SAFETYNOTEBOOK_QAESENCRYPTION_H
#define SAFETYNOTEBOOK_QAESENCRYPTION_H
...
public:
    ...
    QByteArray removePadding(const QByteArray &rawText, int alignment);
...
#endif //SAFETYNOTEBOOK_QAESENCRYPTION_H
